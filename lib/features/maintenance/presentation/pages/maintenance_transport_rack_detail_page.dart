...
class MaintenanceTransportRackDetailPage extends ConsumerWidget {
  final String rackId;

  const MaintenanceTransportRackDetailPage({super.key, this.rackId = '2141412'});
        ...
        children: [
          Expanded(
            child: Text(
              value,
              style: TextStyle(
                color: value == 'Select Process' || value == 'Select Maintenance Status' || value == 'Transport Rack Remark'
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _field(context, '251244', isDisabled: true),
                        ...
                        _labelText('Remark', required: true),
                        SizedBox(height: _sh(context, 8)),
                        Container(
                          width: double.infinity,
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              // History rows
                              ...[
                                {'process': 'Drying', 'date': '25/02/2025', 'by': 'Thruston Moore'},
                                {'process': 'Painting, Blasting', 'date': '25/02/2025', 'by': 'Thruston Moore'},
                                {'process': 'Painting, Blasting', 'date': '25/02/2025', 'by': 'Thruston Moore'},
