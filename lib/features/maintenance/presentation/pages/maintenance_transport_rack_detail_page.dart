...
class MaintenanceTransportRackDetailPage extends ConsumerWidget {
  ...
  const MaintenanceTransportRackDetailPage({super.key, this.rackId = '12341'});
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _field(context, '12341', isDisabled: true),
                          ...
                          SizedBox(height: _sh(context, 8)),
                          _field(context, 'Warehouse A, Rack 5', isDisabled: true),
                          SizedBox(height: _sh(context, 16)),
                          ...
                          SizedBox(height: _sh(context, 8)),
                          _field(context, '24', isDisabled: true),
                          SizedBox(height: _sh(context, 16)),
                          ...
                          SizedBox(height: _sh(context, 8)),
                          _field(context, '15/06/2024', isDisabled: true),
                          SizedBox(height: _sh(context, 24)),
