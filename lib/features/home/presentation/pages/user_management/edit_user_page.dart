...
class _EditUserPageState extends ConsumerState<EditUserPage> {
  ...
  void _initializeControllers() {
    ...
    final decodedUserName = Uri.decodeComponent(widget.userName);
    final userDetail = mockUsers[decodedUserName] ?? mockUsers['Ramdan Hasyim']!;

    _nameController = TextEditingController(text: userDetail['name'] as String);
    _usernameController = TextEditingController(text: userDetail['username'] as String);
    _emailController = TextEditingController(text: userDetail['email'] as String);
    _passwordController = TextEditingController();
    _confirmPasswordController = TextEditingController();
    selectedRole = userDetail['role'] as String;
    selectedStatus = userDetail['status'] as String;
  }
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: screenHeight * 0.02),
                  _buildFormField('Password', 'Leave blank to keep current password', _passwordController, screenWidth, obscureText: true),
                  SizedBox(height: screenHeight * 0.02),
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                // TODO: Submit form and edit user
                                ScaffoldMessenger.of(context).showSnackBar(
